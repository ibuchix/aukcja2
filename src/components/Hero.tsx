        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          >
            <div className="space-y-8">
              <h1 className="text-4xl md:text-3xl font-bold text-body-text" style={{ lineHeight: '1.4' }}>
                Aukcja samochodowa <span className="text-primary">online</span>
              </h1>
              <h1 className="text-4xl md:text-3xl font-bold text-body-text mt-2" style={{ lineHeight: '1.4' }}>
