    ...
    <Card className="bg-secondary border-accent/20">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-body-text">
          <FileDown className="w-5 h-5 text-iris" />
      ...
      <CardContent>
        <div className="grid gap-6">
          ...
          <div className="bg-background p-4 rounded-lg border border-accent/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-subtitle-text">
          ...
          {/* Signature Dates */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-body-text">Daty Podpisów</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
