    ...
    <div className="bg-[#D81B24] text-white py-3 px-4 mt-20">
      <div className="container mx-auto flex items-center justify-center gap-2 text-center flex-wrap text-sm md:text-base">
        ...
        <a 
          ...
          className="font-semibold hover:underline underline-offset-2 transition-all text-background"
        >
        ...
        <a 
          ...
          className="font-semibold hover:underline underline-offset-2 flex items-center gap-1 transition-all text-background"
        >
