-- Fix the update_auction_status function to handle jsonb return from process_ended_auctions
...
BEGIN
  ...
  -- This function returns jsonb, not integer
  SELECT public.process_ended_auctions() INTO v_processed_result;

  -- Build result
  v_result := jsonb_build_object(
    'started_auctions', v_started_count,
    'completed_auctions', v_completed_count,
    'processed_auctions_result', v_processed_result,
    'timestamp', NOW(),
    'success', true
  );
