...
-- Recreate with single-bidder logic added
...
BEGIN
    ...
    LOOP
        ...
        -- Get highest bid and second highest bid
        SELECT 
        ...
        -- Determine winning amount with single-bidder logic
        IF original_amount >= auction_record.reserve_price THEN
            ...
            IF second_highest_amount IS NOT NULL THEN
                -- Multiple bidders: standard proxy logic
                ...
                END IF;
            ELSE
                -- NEW: Single bidder pays reserve price when bid >= reserve
                winning_amount := auction_record.reserve_price;
                RAISE LOG 'Reserve MET - Single bidder: pays reserve price % (original bid: %)', 
                    winning_amount, original_amount;
            END IF;
        ELSE
