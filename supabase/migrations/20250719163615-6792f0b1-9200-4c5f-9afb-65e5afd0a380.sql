...
-- Ensure the cron job exists and runs every 2 minutes for better responsiveness
-- First, try to unschedule any existing auction status job
SELECT cron.unschedule('auction-status-sync');

-- Schedule the enhanced auction status synchronization job
